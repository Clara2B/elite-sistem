...
| 5 — Gestão de Processos (ELITE) | 🟡 Levantamento de requisitos em andamento | Setor "Líder - Gestão de Processos" já existe no modelo, esperando o módulo. Nenhuma linha de código ainda — sem regra de negócio documentada para esse domínio. |
